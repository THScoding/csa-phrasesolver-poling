...
{ 
  ...
  private String removeExtraSpaces(String guess) {
    ...
    //Alternative that doesn't use regex: solvedPhrase.replace("  ", "|").replace(" ", "").replace("|", " ")
  }
...
catch (FileNotFoundException e)
{
  ...
  /**
   *  Update solvedPhrase by replacing underscore with the guessed letter, for each position it appears in the phrase.
   *  
   *  @return count of letter in phrase; Returns 0 if letter not found OR if letter was already guessed
   */ 
